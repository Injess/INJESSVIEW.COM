    ...
    if (!$conn) {
        ...
        <script type="text/javascript">
            document.addEventListener("DOMContentLoaded", function(event) {
                swal("DATABASE UNAVAILABLE", "Admin login is temporarily unavailable because the database connection failed.", "error");
            })
        </script>
        <?php
    } else {
        ...
        if ($query_run = mysqli_query($conn, $query)) {
            ...
            <script type="text/javascript">
                document.addEventListener("DOMContentLoaded", function(event) {
                    swal("DATABASE ERROR", "Unable to query the admin database.", "error");
                })
            </script>
            <?php
        }
